  ...
  return `
    <!--Estructura juego-->
      ...
      <div class="case-1">
        ...
        <div class="board">
          <div class="fila">
            <div id="0" class="col-board"> </div>
            <div id="1" class="col-board"> </div>
            <div id="2" class="col-board"> </div>
          </div>
          <div class="fila">
            <div id="3" class="col-board"> </div>
            <div id="4" class="col-board"> </div>
            <div id="5" class="col-board"> </div>
          </div>
          <div class="fila">
            <div id="6" class="col-board"> </div>
            <div id="7" class="col-board"> </div>
            <div id="8" class="col-board"> </div>
          </div>
        </div>
        <div class="player-2">
          <div class="info-player1">
